...
public abstract class AppBaseDeDatos extends RoomDatabase {
    ...
    static void insertarJuegosIniciales(App app){
        executor.execute(() -> {
            app.insertarContingut(new Juego("Rocket", "2019", "PC","file:///android_asset/cyberpunk_portada.jpg"));
            app.insertarContingut(new Juego("Genshin", "2019", "PC","file:///android_asset/cyberpunk_portada.jpg"));
            app.insertarContingut(new Juego("Valorant", "2019", "PC",  "file:///android_asset/cyberpunk_portada.jpg"));
            app.insertarContingut(new Juego("Warzone", "2019", "PC","file:///android_asset/cyberpunk_portada.jpg"));
            app.insertarContingut(new Juego("Runeterra", "2019", "PC", "file:///android_asset/cyberpunk_portada.jpg"));
            app.insertarContingut(new Juego("R", "2019", "PC","file:///android_asset/cyberpunk_portada.jpg"));
